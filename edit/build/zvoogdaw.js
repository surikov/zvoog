...
var ZvoogPopup = /** @class */ (function () {
    ...
    ZvoogPopup.prototype.fillLayersMenu = function () {
                ...
                var _loop_3 = function (k2) {
                    ...
                    items.push({
                        ...
                        /*, css: this.app.isVoiceSelected(k1, k2)
                            ? 'fillColorContent'
                            //: this.currentSong.selectedLayer.source_voiceFx_trackParam > 0 || this.currentSong.selectedLayer.voice_trackFx_songFxParam >= track.voices.length
                            ...
                            if (this_1.app.isVoiceFxActive(k1, k2, k3)) {
                                ...
                                if (pars) {
                                    for (var k4 = 0; k4 < pars.length; k4++) {
                                        ...
                                        items.push({
                                            label: zp.label(),
                                            css: this_1.app.isVoiceFxParameterSelected(k1, k2, k3, k4) ? 'fillColorContent' : 'fillColorSub',
                                            padding: 3, path128: ZvoogIcons.iconPathGraph128, subMenu: [],
        ...
        items.push({
            label: 'theme', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, padding: 0,
            subMenu: [
                { label: '80th', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_80th.css'); } },
                { label: 'argon', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_argon.css'); } },
                { label: 'bumaga', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_bumaga.css'); } },
                { label: 'hohloma', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_hohloma.css'); } },
                { label: 'iskra', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_iskra.css'); } },
                { label: 'margarin', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_margarin.css'); } },
                { label: 'osen', css: 'fillColorOther', path128: ZvoogIcons.iconPathUndo128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_osen.css'); } },
                { label: 'tina', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: function () { _this.app.setCSS('./css/zvoogcolors_tina.css'); } }
            ]
        }, {
            label: 'New project', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, padding: 0, subMenu: [
                { label: 'Empty', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: this.app.createEmptyProject.bind(this) },
                { label: 'Random', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: this.app.createRandomProject.bind(this) },
                { label: 'Import MIDI', css: 'fillColorOther', path128: ZvoogIcons.iconPathGear128, subMenu: [], padding: 0, action: this.app.importTestMIDI }
            ]
        });
        return items;
    };
...
var UndoRedoSelectLayer = /** @class */ (function () {
    ...
    UndoRedoSelectLayer.prototype.undo = function (app) {
        app.currentSong.selectedLayer.track_songFx = this.props.oldSelection.track_songFx;
        app.currentSong.selectedLayer.voice_trackFx_songFxParam = this.props.oldSelection.voice_trackFx_songFxParam;
        app.currentSong.selectedLayer.source_voiceFx_trackParam = this.props.oldSelection.source_voiceFx_trackParam;
        app.currentSong.selectedLayer.sourceParam_voiceFxParam = this.props.oldSelection.sourceParam_voiceFxParam;
    };
    ;
    UndoRedoSelectLayer.prototype.redo = function (app) {
        app.currentSong.selectedLayer.track_songFx = this.props.newSelection.track_songFx;
        app.currentSong.selectedLayer.voice_trackFx_songFxParam = this.props.newSelection.voice_trackFx_songFxParam;
        app.currentSong.selectedLayer.source_voiceFx_trackParam = this.props.newSelection.source_voiceFx_trackParam;
        app.currentSong.selectedLayer.sourceParam_voiceFxParam = this.props.newSelection.sourceParam_voiceFxParam;
    };
    ;
...
class UndoRedoMoveTrack implements UndoRedoAction {
    ...
    undo(app: ZvoogApp): void {
        ...
        app.currentSong.selectedLayer.track_songFx=this.props.oldTrackPosition;
        app.currentSong.selectedLayer.voice_trackFx_songFxParam=this.props.oldVoicePosition;
    };
    redo(app: ZvoogApp): void {
        ...
        app.currentSong.selectedLayer.track_songFx=this.props.newTrackPosition;
        app.currentSong.selectedLayer.voice_trackFx_songFxParam=this.props.newVoicePosition;
    };
}
    ...
    ZvoogPlayer.prototype.findInstrument = function (program) {
        for (var i = 0; i < this.instrumentKeys().length; i++) {
            ...
            if (program == parseInt(num) + 1) {
                //console.log('found', program, i,num,(parseInt(num) + 1),this.instrumentKeys()[i]);
                return i;
            }
        }
    ...
    ZvoogFxGain.prototype.prepare = function (audioContext) {
        ...
        this.gainParam = {
            ...
            cancelScheduledValues: function (cancelTime) {
                //console.log('cancelScheduledValues',cancelTime,'now',audioContext.currentTime);
                me.base.gain.cancelScheduledValues(cancelTime);
            },
            linearRampToValueAtTime: function (value, endTime) {
                //console.log('linearRampToValueAtTime',value,endTime,'now',audioContext.currentTime);
                me.base.gain.linearRampToValueAtTime(value / 120, endTime);
            },
            setValueAtTime: function (value, startTime) {
                //console.log('setValueAtTime',value,startTime,'now',audioContext.currentTime);
                me.base.gain.setValueAtTime(value / 120, startTime);
            }
        };
        this.params = [];
...
var ZvoogInstrumentSource = /** @class */ (function () {
    ...
    ZvoogInstrumentSource.prototype.schedule = function (when, tempo, chord) {
        //console.log(this.midi,'schedule',when, tempo, chord,this.zones);
        if (this.zones) {
            for (var i = 0; i < chord.length; i++) {
...
var MidiParser = /** @class */ (function () {
    function MidiParser(arrayBuffer) {
        ...
        this.EVENT_META_MIDI_CHANNEL_PREFIX = 0x20; //https://www.recordingblogs.com/wiki/midi-channel-prefix-meta-message
        this.EVENT_META_END_OF_TRACK = 0x2f;
        this.EVENT_META_SET_TEMPO = 0x51;
        this.EVENT_META_SMTPE_OFFSET = 0x54;
        this.EVENT_META_TIME_SIGNATURE = 0x58; //https://www.recordingblogs.com/wiki/midi-time-signature-meta-message
        this.EVENT_META_KEY_SIGNATURE = 0x59; //https://www.recordingblogs.com/wiki/midi-key-signature-meta-message
    ...
    MidiParser.prototype.convert = function () {
        ...
        var cuti = 0;
        var curBPM = midisong.bpm;
        for (var i_3 = 0; i_3 < schedule.timeline.length; i_3++) {
            var measure_1 = schedule.timeline[i_3];
            for (var k = 0; k < midisong.tempos.length; k++) {
                var pp = duration2time(160, duration384(measure_1.meter));
                if (midisong.tempos[k].ms >= cuti * 1000 && midisong.tempos[k].ms < (cuti + pp) * 1000) {
                    curBPM = Math.round(midisong.tempos[k].bmp);
                    break;
                }
            }
            measure_1.tempo = curBPM;
            var tt = duration2time(measure_1.tempo, duration384(measure_1.meter));
            cuti = cuti + tt;
        ...
        for (var i = 0; i < midisong.tracks.length; i++) {
            ...
            if (miditrack.volumes.length) {
                ...
                for (var kk = 0; kk < miditrack.volumes.length; kk++) {
                    ...
                    //console.log(i, kk, measureN, miditrack.volumes[kk], miditrack.title, deltatime, delta384);
                    volumePoints.push({
        ...
        /*midisong.tempos.sort(
            ((a: { seconds: number; bmp: number; }, b: { seconds: number; bmp: number; }) => {
                return a.seconds - b.seconds;
            }));*/
        //console.log(midisong.tempos);
        return schedule;
    };
...
var ZvoogApp = /** @class */ (function () {
    function ZvoogApp() {
        this.minZoom = 1;
        this.maxNotesSpotZoom = 16;
        this.maxBlackWhiteZoom = 25;
        this.maxOtherZoom = 100;
        this.maxMainZoom = 300;
        this.maxZoom = 1024;
        this.menuStyleWidth = '7cm';
        //tickPositionMs=0;
        this.gridIndentUp = 256;
        this.gridIndentDown = 50;
        this.gridIndentLeft = 30;
        this.gridIndentRight = 90;
    ...
    ZvoogApp.prototype.selectLockedPluginLayer = function () {
        for (var e = 0; e < this.currentSong.effects.length; e++) {
            var fx = this.currentSong.effects[e];
            if (fx.plugin.busy()) {
                this.currentSong.selectedLayer = { track_songFx: e + 1 + this.currentSong.tracks.length, voice_trackFx_songFxParam: 0, source_voiceFx_trackParam: 0, sourceParam_voiceFxParam: 0 };
                return true;
            }
        }
        for (var e = 0; e < this.currentSong.tracks.length; e++) {
            ...
            for (var n = 0; n < track.effects.length; n++) {
                var fx = track.effects[n];
                if (fx.plugin.busy()) {
                    this.currentSong.selectedLayer = { track_songFx: e + 1, voice_trackFx_songFxParam: n + 1, source_voiceFx_trackParam: 0, sourceParam_voiceFxParam: 0 };
                    return true;
                }
            }
            for (var k = 0; k < track.voices.length; k++) {
                ...
                if (voice.source.plugin.busy()) {
                    this.currentSong.selectedLayer = { track_songFx: e + 1, voice_trackFx_songFxParam: k + 1, source_voiceFx_trackParam: 1, sourceParam_voiceFxParam: 0 };
                    return true;
                }
                for (var n = 0; n < voice.effects.length; n++) {
                    var fx = voice.effects[n];
                    if (fx.plugin.busy()) {
                        this.currentSong.selectedLayer = { track_songFx: e + 1, voice_trackFx_songFxParam: k + 1, source_voiceFx_trackParam: 1 + n + 1, sourceParam_voiceFxParam: 0 };
                        return true;
                    }
                }
            }
    ...
    ZvoogApp.prototype.start = function () {
        ...
        this.currentSong.effects[0].parameters[0].points.push({ skipMeasures: 3, skip384: 55, velocity: 77 });
        this.currentSong.effects[0].parameters[0].points.push({ skipMeasures: 1, skip384: 111, velocity: 3 });
        ...
        this.currentSong.effects[0].parameters[0].points.push({ skipMeasures: 2, skip384: 0, velocity: 99 });
        this.currentSong.effects[0].parameters[0].points.push({ skipMeasures: 2, skip384: 0, velocity: 11 });
        this.currentSong.effects[0].parameters[0].points.push({ skipMeasures: 1, skip384: 0, velocity: 88 });
        ...
        if (this.audioTimeMs) {
            ...
            if (this.audioTimeMs + 0.5 * this.tickDurationMs < t) {
                ...
                if (this.lastSongPositionMs + this.tickDurationMs > endSongSelectionMs) {
                    ...
                    ZvoogTicker.sendSongData(this, this.audioTimeMs, this.lastSongPositionMs, endSongSelectionMs, startSongSelectionMs, endSongSelectionMs);
                    ZvoogTicker.sendSongData(this, this.audioTimeMs + tickRest, startSongSelectionMs, startSongSelectionMs + overFlowMs, startSongSelectionMs, endSongSelectionMs);
                    this.lastSongPositionMs = startSongSelectionMs + overFlowMs;
                }
                else {
                    if (this.lastSongPositionMs < startSongSelectionMs) {
                        this.lastSongPositionMs = startSongSelectionMs;
                    }
                    ZvoogTicker.sendSongData(this, this.audioTimeMs, this.lastSongPositionMs, this.lastSongPositionMs + this.tickDurationMs, startSongSelectionMs, endSongSelectionMs);
    ...
    ZvoogApp.prototype.resetButtons = function () {
        ...
        this.addMainTextButton(256, 155, 32, this.currentSong.description, 'fontSize16', this.workButtonsGroup.content, this.promptDescription);
...
*/
    ...
    ZvoogApp.prototype.togglePlay = function () {
        ...
        if (this.audioTimeMs) {
            ...
            ZvoogTicker.cancelAllParameters(this);
            this.resetWholeProject();
        }
        else {
    ...
    ZvoogApp.prototype.isTrackActive = function (track) {
        if (track + 1 == this.currentSong.selectedLayer.track_songFx) {
            return true;
        }
        return false;
    };
    ZvoogApp.prototype.isTrackSelected = function (track) {
        if (this.isTrackActive(track)) {
            if (this.currentSong.selectedLayer.voice_trackFx_songFxParam == 0) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isFxActive = function (fx) {
        if (this.currentSong.tracks.length + fx + 1 == this.currentSong.selectedLayer.track_songFx) {
            return true;
        }
        return false;
    };
    ...
    ZvoogApp.prototype.isFxParameterSelected = function (fx, par) {
        if (this.isFxActive(fx)) {
            if (par + 1 == this.currentSong.selectedLayer.voice_trackFx_songFxParam) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isTrackFxActive = function (track, fx) {
        if (this.isTrackActive(track)) {
            if (this.currentSong.tracks[track].voices.length + fx + 1 == this.currentSong.selectedLayer.voice_trackFx_songFxParam) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isTrackFxSelected = function (track, fx) {
        if (this.isTrackFxActive(track, fx)) {
            if (this.currentSong.selectedLayer.source_voiceFx_trackParam == 0) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isTrackFxParameterSelected = function (track, fx, par) {
        if (this.isTrackFxActive(track, fx)) {
            if (par + 1 == this.currentSong.selectedLayer.source_voiceFx_trackParam) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isVoiceActive = function (track, voice) {
        if (this.isTrackActive(track)) {
            if (voice + 1 == this.currentSong.selectedLayer.voice_trackFx_songFxParam) {
                return true;
            }
        }
        return false;
        ...
        if (this.isTrackActive(track)) {
            if (!this.isVoiceSelected(track, voice)) {
                if (this.currentSong.tracks.length > track) {
                    if (this.currentSong.selectedLayer.voice_trackFx_songFxParam <= this.currentSong.tracks[track].voices.length) {
                        if (this.currentSong.selectedLayer.source_voiceFx_trackParam == 0) {
                            return true;
                        }
                    }
    ...
    ZvoogApp.prototype.isVoiceSourceActive = function (track, voice) {
        if (this.isVoiceActive(track, voice)) {
            if (this.currentSong.selectedLayer.source_voiceFx_trackParam == 1) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isVoiceSourceSelected = function (track, voice) {
        if (this.isVoiceSourceActive(track, voice)) {
            if (this.currentSong.selectedLayer.sourceParam_voiceFxParam == 0) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isVoiceSourceParameterSelected = function (track, voice, par) {
        if (this.isVoiceSourceActive(track, voice)) {
            if (par + 1 == this.currentSong.selectedLayer.sourceParam_voiceFxParam) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.isVoiceFxActive = function (track, voice, fx) {
        if (this.isVoiceActive(track, voice)) {
            if (fx + 1 + 1 == this.currentSong.selectedLayer.source_voiceFx_trackParam) {
                return true;
            }
        }
        return false;
    ...
    ZvoogApp.prototype.openLayersPopup = function () {
        ...
        this.popup.showPopupMenu(popupX, popupY, popupZ, popupZ / 2, this.popup.fillLayersMenu());
    };
    ...
    ZvoogApp.prototype.createSelectLayerAction = function (c1, c2, c3, c4) {
        ...
        return function () {
            ...
            me.undoRedo.addRedo({
                ...
                properties: {
                    oldSelection: {
                        track_songFx: me.currentSong.selectedLayer.track_songFx,
                        voice_trackFx_songFxParam: me.currentSong.selectedLayer.voice_trackFx_songFxParam,
                        source_voiceFx_trackParam: me.currentSong.selectedLayer.source_voiceFx_trackParam,
                        sourceParam_voiceFxParam: me.currentSong.selectedLayer.sourceParam_voiceFxParam
                    },
                    newSelection: {
                        track_songFx: c1,
                        voice_trackFx_songFxParam: c2,
                        source_voiceFx_trackParam: c3,
                        sourceParam_voiceFxParam: c4
                    }
                }
            });
        ...
        return function (): void {
            ...
            me.undoRedo.addRedo({
                key: undoRedoMoveVoice, point: me.uiTapPosition(), properties: {
                    oldTrackPosition: me.currentSong.selectedLayer.track_songFx
                    , newTrackPosition: t
                    , oldVoicePosition: me.currentSong.selectedLayer.voice_trackFx_songFxParam
                    , newVoicePosition: v
                }
            });
            me.popup.closePopupMenu1();
    ...
    ZvoogApp.prototype.promptDescription = function () {
        var result = window.prompt('Description', this.currentSong.description);
    ...
    ZvoogApp.prototype.createLayers = function () {
        ...
        this.labelsStaticAnchor = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxMainZoom, content: [] };
        ...
        this.keyZoomAnchor = { xx: 0, yy: this.gridIndentUp, ww: 1, hh: 120 * this.noteLineWidth, showZoom: this.minZoom, hideZoom: this.maxBlackWhiteZoom,
            content: [] };
        this.keyWholeAnchor = { xx: 0, yy: this.gridIndentUp, ww: 1, hh: 120 * this.noteLineWidth, showZoom: this.maxBlackWhiteZoom, hideZoom: this.maxZoom,
            content: [] };
        this.meterPatternAnchor = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxZoom, content: [] };
        this.mainTapWatchRectangle = { x: 0, y: 0, w: 1, h: 1, rx: 0, ry: 0, css: 'fillButtonActionPoint', action: ZvoogDraw.notesPaneClick };
        this.mainTapWatchAnchor = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxNotesSpotZoom,
            content: [this.mainTapWatchRectangle] };
        this.firstAnchor = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxMainZoom, content: [] };
        this.secondAnchor = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxOtherZoom, content: [] };
        this.otherAnchor = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxOtherZoom, content: [] };
        this.workButtonsGroup = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxZoom, content: [] };
        this.tickerLineAnchor = { xx: 0, yy: 0, ww: 1, hh: 1, showZoom: this.minZoom, hideZoom: this.maxZoom, content: [] };
        ...
        layers.push({
            g: document.getElementById('labelsBottomGroup'),
            anchors: [
        ...
        layers.push({
            g: document.getElementById('bottomTogglesGroup'),
            anchors: [
        ...
        layers.push({
            g: document.getElementById('labelsLeftGroup'),
            anchors: [
        ...
        layers.push({ g: document.getElementById('mainTapWatchGroup'), anchors: [this.mainTapWatchAnchor] });
        layers.push({ g: document.getElementById('tickerLineGroup'), anchors: [this.tickerLineAnchor] });
        layers.push({ g: document.getElementById('workButtonsGroup'), anchors: [this.workButtonsGroup] });
        this.popupLayer = {
            g: document.getElementById('popupGroup'),
            anchors: [this.popupMenuGroup1,
    ...
    ZvoogApp.prototype.resetFieldSize = function () {
        ...
        this.mainTapWatchAnchor.ww = this.tileLevel.innerWidth / this.tileLevel.tapSize;
        this.mainTapWatchAnchor.hh = this.tileLevel.innerHeight / this.tileLevel.tapSize;
        this.mainTapWatchRectangle.x = this.gridIndentLeft;
        this.mainTapWatchRectangle.y = this.gridIndentUp;
        this.mainTapWatchRectangle.w = ZvoogGrid.calculateGridWidth(this);
        this.mainTapWatchRectangle.h = 120 * this.noteLineWidth;
        ...
        this.tickerLineAnchor.ww = this.tileLevel.innerWidth / this.tileLevel.tapSize;
        this.tickerLineAnchor.hh = this.tileLevel.innerHeight / this.tileLevel.tapSize;
...
var ZvoogDraw;
(function (ZvoogDraw) {
    function createNoteHeadClick(key) {
        return function (x, y) {
            console.log('click key', key);
        };
    }
    ZvoogDraw.createNoteHeadClick = createNoteHeadClick;
    function notesPaneClick(x, y) {
        console.log('click pane', x, y);
        var app = window.zvoogApp;
        resetMark(x, y, app);
    }
    ZvoogDraw.notesPaneClick = notesPaneClick;
    function resetMark(x, y, app) {
        console.log('resetMark', app.currentSong.selectedLayer);
        var curveOrVoice = findEditableLayer(app);
        if (curveOrVoice) {
            if (curveOrVoice.source) {
                var voice = curveOrVoice;
                console.log('voice', voice);
            }
            else {
                var curve = curveOrVoice;
                console.log('curve', curve);
            }
        }
        var mx = 0;
        var measure = app.currentSong.timeline[0];
        var measureIdx = 0;
        for (var i = 0; i < app.currentSong.timeline.length; i++) {
            measure = app.currentSong.timeline[i];
            var nextMeasureX = mx + app.patternDuration(measure) * app.lengthOfSecond;
            if (x >= mx && x < nextMeasureX) {
                measureIdx = i;
                break;
            }
            else {
        ...
        var patx = 0;
        //let patIdx = 0;
        var x384 = Math.round(time2Duration(x - mx, measure.tempo) / app.lengthOfSecond);
        var wi384 = -1;
        for (var i = 0; i < app.currentSong.gridPattern.length; i++) {
            if (x384 < patx + app.currentSong.gridPattern[i].duration) {
                x384 = patx;
                wi384 = app.currentSong.gridPattern[i].duration;
                //patIdx = i;
                break;
            }
            else {
                patx = patx + app.currentSong.gridPattern[i].duration;
            }
        }
        var mkey = Math.ceil(120 - y / app.noteLineWidth);
        if (app.markMeasureIndex < 0) {
            app.markMeasureIndex = measureIdx;
            app.markStep384 = x384;
            app.markKey = mkey;
            app.markWidth384 = wi384;
        }
        else {
            putNewNoteToCurrentLayer(app.markKey, app.markMeasureIndex, app.markStep384, mkey, measureIdx, wi384 + x384, app);
            app.markMeasureIndex = -1;
            app.markStep384 = -1;
            app.markKey = -1;
            app.markWidth384 = -1;
        }
        app.resetWholeProject();
        //console.log('findNotePosition', app.markMeasureIndex,app.markStep384,app.markWidth384,app.markKey);
    }
    ZvoogDraw.resetMark = resetMark;
    function findEditableLayer(app) {
        //console.log('selectEditableLayer', app.currentSong.selectedLayer);
        for (var t = 0; t < app.currentSong.tracks.length; t++) {
            ...
            for (var v = 0; v < track.voices.length; v++) {
                if (app.isVoiceSelected(t, v)) {
                    return track.voices[v];
                }
                var voice = track.voices[v];
                for (var p_1 = 0; p_1 < voice.source.parameters.length; p_1++) {
                    if (app.isVoiceSourceParameterSelected(t, v, p_1)) {
                        return voice.source.parameters[p_1];
                    }
                }
                for (var f = 0; f < voice.effects.length; f++) {
                    var effect = voice.effects[f];
                    for (var p = 0; p < effect.parameters.length; p++) {
                        if (app.isVoiceFxParameterSelected(t, v, f, p)) {
                            return effect.parameters[p];
                        }
                    }
                }
            }
            for (var f = 0; f < track.effects.length; f++) {
                var effect = track.effects[f];
                for (var p = 0; p < effect.parameters.length; p++) {
                    if (app.isTrackFxParameterSelected(t, f, p)) {
                        return effect.parameters[p];
                    }
                }
            }
        }
        for (var f = 0; f < app.currentSong.effects.length; f++) {
            var effect = app.currentSong.effects[f];
            for (var p = 0; p < effect.parameters.length; p++) {
                if (app.isFxParameterSelected(f, p)) {
                    return effect.parameters[p];
                }
            }
        }
    ...
    function putNewNoteToCurrentLayer(fromKey, fromMeasureIdx, fromPosition384, toKey, toMeasureIdx, toPosition384, app) {
        console.log('putNewNoteToCurrentLayer', fromKey, fromMeasureIdx, fromPosition384, toKey, toMeasureIdx, toPosition384);
        for (var t = 0; t < app.currentSong.tracks.length; t++) {
            var track = app.currentSong.tracks[t];
            if (!track.disabled) {
                for (var v = 0; v < track.voices.length; v++) {
                    ...
                    if (!voice.disabled) {
                        if (app.isVoiceSelected(t, v)) {
                            console.log('found voice', voice.title);
                            break;
                        }
                    }
                }
                        ...
                        if (effect.parameters.length > k2) {
                            ...
                            if (app.isFxActive(k1)) {
                                if (app.isFxParameterSelected(k1, k2)) {
                                    console.log('found sound fx', effect.plugin.label(), 'curve', curve);
                                    break;
                                }
                            }
                        }
                                ...
                                if (effect.parameters.length > k3) {
                                    if (app.isTrackFxActive(k1, k2)) {
                                        if (app.isTrackFxParameterSelected(k1, k2, k3)) {
                                            console.log('found track' + track.title + 'fx', effect.plugin.label(), 'par', k3);
                                            break;
                                        }
                                    }
                                }
                                ...
                                if (voice.source.parameters.length > k4) {
                                    if (app.isVoiceSourceActive(k1, k2)) {
                                        if (app.isVoiceSourceParameterSelected(k1, k2, k4)) {
                                            console.log('found track' + track.title + 'source', voice.source.plugin.label(), 'par', k4);
                                            break;
                                        }
                                    }
                                }
                                        ...
                                        if (effect.parameters.length > k4) {
                                            if (app.isVoiceFxActive(k1, k2, k3)) {
                                                if (app.isVoiceFxParameterSelected(k1, k2, k3, k4)) {
                                                    console.log('found track' + track.title + 'fx', effect.plugin.label(), 'par', k4);
                                                    break;
                                                }
                                            }
                                        }
    ...
    function addParameterCurve(app, curve, tile, cssSegment, joint) {
        var measureX = 0;
        var measureIndex = 0;
        var x384 = 0;
        var prex = app.gridIndentLeft + measureX;
        var prey = app.gridIndentUp + (120 - 0.5 - 0) * app.noteLineWidth - 2;
        ;
        for (var i = 0; i < curve.points.length; i++) {
            var point = curve.points[i];
            var curMeasure = app.currentSong.timeline[0];
            for (var m = 0; m < point.skipMeasures; m++) {
                measureX = measureX + app.patternDuration(app.currentSong.timeline[measureIndex]) * app.lengthOfSecond;
                curMeasure = app.currentSong.timeline[measureIndex];
                measureIndex++;
                x384 = 0;
            }
            x384 = x384 + point.skip384;
            var x = app.gridIndentLeft + measureX + duration2time(curMeasure.tempo, x384) * app.lengthOfSecond;
            var y = app.gridIndentUp + (120 - 0.5 - point.velocity) * app.noteLineWidth - 2;
            tile.content.push(app.tileLevel.line(prex + 0.5, prey + 2, x + 0.5, y + 2, cssSegment));
            if (joint) {
                tile.content.push(app.tileLevel.rectangle(x - 6 + 0.5, y - 4, 12, 12, 6, 6, 'fillFlatSpot'));
            }
            prex = x;
            prey = y;
        }
        var endX = app.gridIndentLeft + durations2time(app.currentSong.timeline) * app.lengthOfSecond;
        tile.content.push(app.tileLevel.line(prex + 0.5, prey + 2, endX + 0.5, prey + 2, cssSegment));
    }
    ZvoogDraw.addParameterCurve = addParameterCurve;
                    ...
                    if (!voice.disabled) {
                        ...
                        for (var k3 = 0; k3 < voice.effects.length; k3++) {
                            ...
                            if (!effect.disabled) {
                                ...
                                if (pars_4) {
                                    for (var k4 = 0; k4 < pars_4.length; k4++) {
                                        if (effect.parameters.length > k4) {
    ...
    ZvoogDraw.addCurvesForParameters = addCurvesForParameters;
    function addNoteLine(app, anchor, nextMeasureX, measure, chunk, chord, key, css) {
        ...
        for (var i = 0; i < key.envelope.length; i++) {
            var iWidth = duration2time(measure.tempo, key.envelope[i].duration) * app.lengthOfSecond;
            var slide = 0;
            ...
            var dx = 0;
            if (i > 0) {
                dx = app.noteLineWidth;
            }
            anchor.content.push(app.tileLevel.line(noteX + 0.5 * app.noteLineWidth - dx, noteY, noteX + iWidth - 0.5 * app.noteLineWidth, noteY + slide * app.noteLineWidth, css));
            noteY = noteY + slide * app.noteLineWidth;
            noteX = noteX + iWidth;
        }
    }
    ZvoogDraw.addNoteLine = addNoteLine;
    function addChordNotes(app, chunkAnchor, nextMeasureX, measure, chunk, css) {
        for (var ch = 0; ch < chunk.chords.length; ch++) {
            var chord = chunk.chords[ch];
            for (var n = 0; n < chord.values.length; n++) {
                var key = chord.values[n];
                ZvoogDraw.addNoteLine(app, chunkAnchor, nextMeasureX, measure, chunk, chord, key, css);
            }
        }
    }
    ZvoogDraw.addChordNotes = addChordNotes;
    function addMark(app, chunkAnchor, nextMeasureX, measure, chunk, css) {
        if (app.markMeasureIndex >= 0 && app.markStep384 >= 0 && app.markKey >= 0) {
            chunkAnchor.content.push(app.tileLevel.actionRectangle(function (x, y) {
                putNewNoteToCurrentLayer(app.markKey, app.markMeasureIndex, app.markStep384, app.markKey, app.markMeasureIndex, app.markStep384 + app.markWidth384, app);
                app.markMeasureIndex = -1;
                app.markStep384 = -1;
                app.markKey = -1;
                app.markWidth384 = -1;
                app.resetWholeProject();
            }, nextMeasureX + app.gridIndentLeft + duration2time(measure.tempo, app.markStep384) * app.lengthOfSecond, (120 - app.markKey) * app.noteLineWidth + app.gridIndentUp, duration2time(measure.tempo, app.markWidth384) * app.lengthOfSecond, app.noteLineWidth, 0, 0, 'fillColorContent'));
        }
    }
    ZvoogDraw.addMark = addMark;
    function resetNoteLines(app) {
        app.firstAnchor.content.length = 0;
        app.secondAnchor.content.length = 0;
                    ...
                    if (!voice.disabled) {
                        ...
                        for (var i = 0; i < voice.chunks.length; i++) {
                            ...
                            if (measure) {
                                ...
                                //if (t == app.currentSong.selectedLayer.track_songFx && v == app.currentSong.selectedLayer.voice_trackFx_songFxParam) {
                                if (app.isVoiceSelected(t, v)) {
                                    app.firstAnchor.content.push(chunkAnchor);
                                    ZvoogDraw.addChordNotes(app, chunkAnchor, nextMeasureX, measure, chunk, 'firstLine');
                                    if (i == app.markMeasureIndex)
                                        ZvoogDraw.addMark(app, chunkAnchor, nextMeasureX, measure, chunk, 'firstLine');
                                    var spotAnchor = app.tileLevel.anchor(app.gridIndentLeft + nextMeasureX, app.gridIndentUp, app.patternDuration(measure) * app.lengthOfSecond * 4, 120 * app.noteLineWidth, app.minZoom, app.maxNotesSpotZoom);
                                    ...
                                    for (var ch = 0; ch < chunk.chords.length; ch++) {
                                        ...
                                        for (var n = 0; n < chord.values.length; n++) {
                                            ...
                                            var chordX = app.gridIndentLeft + nextMeasureX + duration2time(measure.tempo, chord.when) * app.lengthOfSecond;
                                            var noteY = app.gridIndentUp + (120 - 0.5 - key.envelope[0].pitch) * app.noteLineWidth;
                                            spotAnchor.content.push(app.tileLevel
                                                .actionRectangle(ZvoogDraw.createNoteHeadClick(key), chordX + 0.5, noteY - 1, 2, 2, 1, 1, 'fillFlatSpot'));
                                        }
                                    }
                                }
                                else {
        ...
        ZvoogDraw.addCurvesForParameters(app);
    }
    ZvoogDraw.resetNoteLines = resetNoteLines;
})(ZvoogDraw || (ZvoogDraw = {}));
var ZvoogGrid;
(function (ZvoogGrid) {
    function resetGrid(app) {
        app.keyZoomAnchor.content.length = 0;
        app.keyWholeAnchor.content.length = 0;
        app.meterPatternAnchor.content.length = 0;
        app.labelsOctaveAnchor16.content.length = 0;
        app.labelsOctaveAnchor8.content.length = 0;
        app.labelsOctaveAnchor4.content.length = 0;
        app.labelsOctaveAnchor2.content.length = 0;
        app.labelsBottomAnchor256.content.length = 0;
        app.labelsBottomAnchor64.content.length = 0;
        app.labelsBottomAnchor16.content.length = 0;
        app.labelsBottomAnchor4.content.length = 0;
        app.bottomTogglesAnchor256.content.length = 0;
        app.bottomTogglesAnchor64.content.length = 0;
        app.bottomTogglesAnchor16.content.length = 0;
        app.bottomTogglesAnchor4.content.length = 0;
        app.tickerLineAnchor.content.length = 0;
        var nextMeasureX = 0;
        /*if (app.currentSong.tracks.length > app.currentSong.selectedLayer.track_songFx) {
            let track: ZvoogTrack = app.currentSong.tracks[app.currentSong.selectedLayer.track_songFx];
            if (track.voices.length > app.currentSong.selectedLayer.voice_trackFx_songFxParam) {
                let voice: ZvoogVoice = track.voices[app.currentSong.selectedLayer.voice_trackFx_songFxParam];
*/
        var songSelectionCss = 'fillSelectionSpot';
        if (app.currentSong.selectedMeasures.duration) {
            songSelectionCss = 'fillSelectionFirst';
        }
        app.labelsBottomAnchor256.content.push(app.tileLevel.text(app.gridIndentLeft + 256 / 4, 0, '1', 'barNum256'));
        app.bottomTogglesAnchor256.content.push(app.tileLevel.actionRectangle(app.createSelectionToggle(0), app.gridIndentLeft + nextMeasureX, -0.5 * 256, 0.5 * 256, 0.5 * 256, 0.5 * 0.5 * 256, 0.5 * 0.5 * 256, songSelectionCss));
        app.labelsBottomAnchor64.content.push(app.tileLevel.text(app.gridIndentLeft + 64 / 4, 0, '1', 'barNum64'));
        app.bottomTogglesAnchor64.content.push(app.tileLevel.actionRectangle(app.createSelectionToggle(0), app.gridIndentLeft + nextMeasureX, -0.5 * 64, 0.5 * 64, 0.5 * 64, 0.5 * 0.5 * 64, 0.5 * 0.5 * 64, songSelectionCss));
        var meCount = 0;
        var meDivision = 0;
        var meBPM = 0;
        for (var i = 0; i < app.currentSong.timeline.length; i++) {
            ...
            var measure = app.currentSong.timeline[i];
            var measureAnchor = {
                xx: app.gridIndentLeft + nextMeasureX,
                yy: app.gridIndentUp,
                ww: app.patternDuration(measure) * app.lengthOfSecond,
                hh: 120 * app.noteLineWidth,
                showZoom: app.minZoom,
                hideZoom: app.maxNotesSpotZoom,
                content: []
            };
            app.meterPatternAnchor.content.push(measureAnchor);
            var farMeasureAnchor = {
                xx: app.gridIndentLeft + nextMeasureX,
                yy: app.gridIndentUp,
                ww: app.patternDuration(measure) * app.lengthOfSecond,
                hh: 120 * app.noteLineWidth,
                showZoom: app.maxNotesSpotZoom,
                hideZoom: app.maxMainZoom,
                content: []
            };
            app.meterPatternAnchor.content.push(farMeasureAnchor);
            var idx = 0;
            var gduration = 0;
            while (gduration < duration384(measure.meter) && idx < app.currentSong.gridPattern.length) {
                var step = app.currentSong.gridPattern[idx];
                var sx = duration2time(measure.tempo, gduration) * app.lengthOfSecond;
                var thick = 0.1;
                if (step.power > 0) {
                    thick = 0.25;
                }
                ...
                if (gduration > 0 || i > 0) {
                    measureAnchor.content.push({
                        x: app.gridIndentLeft + nextMeasureX + sx,
                        y: app.gridIndentUp, w: thick, h: 120 * app.noteLineWidth, css: 'meterLine'
                    });
                }
                gduration = gduration + step.duration;
                idx++;
                if (idx > app.currentSong.gridPattern.length) {
                    idx = 0;
                }
            }
            if (i) {
                farMeasureAnchor.content.push({
                    x: app.gridIndentLeft + nextMeasureX,
                    y: app.gridIndentUp, w: 3, h: 120 * app.noteLineWidth, css: 'meterFarLine'
                });
            }
            //var tinfo = '' + measure.tempo + '\n' + measure.meter.count + '/' + measure.meter.division;
            if (meCount == measure.meter.count && meDivision == measure.meter.division && meBPM == measure.tempo) {
                //
            }
            else {
                meCount = measure.meter.count;
                meDivision = measure.meter.division;
                meBPM = measure.tempo;
                farMeasureAnchor.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX, app.gridIndentUp - 3, '' + meBPM, 'barNum16'));
                farMeasureAnchor.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX, app.gridIndentUp - 3 - 16, '' + meCount + '/' + meDivision, 'barNum16'));
                measureAnchor.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX, app.gridIndentUp - 3, '' + meBPM, 'barNum4'));
                measureAnchor.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX, app.gridIndentUp - 3 - 4, '' + meCount + '/' + meDivision, 'barNum4'));
            }
            //fillSelectionSpot
            if ((i + 1) % 20 == 0) {
                //console.log( -256 * app.tileLevel.tapSize,app.gridIndentLeft + nextMeasureX);
                app.labelsBottomAnchor256.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX + 256 / 4, 0, '' + (1 + i), 'barNum256'));
                app.bottomTogglesAnchor256.content.push(app.tileLevel.actionRectangle(app.createSelectionToggle(i), app.gridIndentLeft + nextMeasureX, -0.5 * 256, 0.5 * 256, 0.5 * 256, 0.5 * 0.5 * 256, 0.5 * 0.5 * 256, songSelectionCss));
            }
            if ((i + 1) % 5 == 0) {
                app.labelsBottomAnchor64.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX + 64 / 4, 0, '' + (1 + i), 'barNum64'));
                app.bottomTogglesAnchor64.content.push(app.tileLevel.actionRectangle(app.createSelectionToggle(i), app.gridIndentLeft + nextMeasureX, -0.5 * 64, 0.5 * 64, 0.5 * 64, 0.5 * 0.5 * 64, 0.5 * 0.5 * 64, songSelectionCss));
            }
            app.labelsBottomAnchor16.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX + 16 / 4, 0, '' + (1 + i), 'barNum16'));
            app.bottomTogglesAnchor16.content.push(app.tileLevel.actionRectangle(app.createSelectionToggle(i), app.gridIndentLeft + nextMeasureX, -0.5 * 16, 0.5 * 16, 0.5 * 16, 0.5 * 0.5 * 16, 0.5 * 0.5 * 16, songSelectionCss));
            app.labelsBottomAnchor4.content.push(app.tileLevel.text(app.gridIndentLeft + nextMeasureX + 4 / 4, 0, '' + (1 + i), 'barNum4'));
            app.bottomTogglesAnchor4.content.push(app.tileLevel.actionRectangle(app.createSelectionToggle(i), app.gridIndentLeft + nextMeasureX, -0.5 * 4, 0.5 * 4, 0.5 * 4, 0.5 * 0.5 * 4, 0.5 * 0.5 * 4, songSelectionCss));
            //console.log('check',i,app.currentSong.selectedMeasures);
            if (i + 1 >= app.currentSong.selectedMeasures.from
                && i + 1 <= app.currentSong.selectedMeasures.from + app.currentSong.selectedMeasures.duration - 1) {
                //console.log('selected',i,app.currentSong.selectedMeasures,app.gridIndentLeft + nextMeasureX);
                app.meterPatternAnchor.content.push(app.tileLevel.rectangle(app.gridIndentLeft + nextMeasureX, app.gridIndentUp, app.patternDuration(measure) * app.lengthOfSecond, 120 * 3, 0, 0, 'fillSelectionSpot'));
            }
            else {
                if (i + 1 == app.currentSong.selectedMeasures.from
                    && app.currentSong.selectedMeasures.duration == 0) {
                    app.meterPatternAnchor.content.push(app.tileLevel.rectangle(app.gridIndentLeft + nextMeasureX, app.gridIndentUp, 1 / 8 * app.lengthOfSecond, 120 * 3, 0, 0, 'fillSelectionFirst'));
                }
            }
            nextMeasureX = nextMeasureX + app.patternDuration(measure) * app.lengthOfSecond;
        }
        app.keyZoomAnchor.ww = nextMeasureX;
        ...
        var tickLine = {
            ...
            w: 16,
            h: 120 * 3,
            id: 'tickLineRectangle',
            css: 'tickerLine'
        };
        app.tickerLineAnchor.content.push(tickLine);
        /*app.tickerLineAnchor.content.push(app.tileLevel.rectangle(app.gridIndentLeft , app.gridIndentUp
            , 16, 120 * 3
            , 0, 0, 'debug'));*/
        //let div:SVGElement=(document.getElementById('tickerLineGroup') as any) as SVGElement;
        //div.style.transform = "translate-x(1000)";
    }
    ZvoogGrid.resetGrid = resetGrid;
    function calculateGridWidth(app) {
        var nextMeasureX = 0;
        for (var i = 0; i < app.currentSong.timeline.length; i++) {
            var measure = app.currentSong.timeline[i];
            nextMeasureX = nextMeasureX + app.patternDuration(measure) * app.lengthOfSecond;
    ...
    ZvoogGrid.calculateGridWidth = calculateGridWidth;
    function resetTrackVoiceName(app) {
        var label1 = '';
        var label2 = '';
        var label3 = '';
        var label4 = '';
        for (var k1 = 0; k1 < app.currentSong.tracks.length; k1++) {
            if (app.isTrackActive(k1)) {
                var track = app.currentSong.tracks[k1];
                label1 = track.title;
                if (!app.isTrackSelected(k1)) {
                    for (var k2 = 0; k2 < track.voices.length; k2++) {
                        if (app.isVoiceActive(k1, k2)) {
                            var voice = track.voices[k2];
                            label2 = voice.title;
                            if (!app.isVoiceSelected(k1, k2)) {
                                if (app.isVoiceSourceActive(k1, k2)) {
                                    var plugin = voice.source.plugin;
                                    label3 = plugin.label();
                                    if (!app.isVoiceSourceSelected(k1, k2)) {
                                ...
                                for (var k3 = 0; k3 < voice.effects.length; k3++) {
                                    if (app.isVoiceFxActive(k1, k2, k3)) {
                                        ...
                                        label3 = plugin.label();
                                        if (!app.isVoiceFxSelected(k1, k2, k3)) {
                                            var pars = plugin.getParams();
                                            if (pars) {
                                                for (var k4 = 0; k4 < pars.length; k4++) {
                                                    if (app.isVoiceFxParameterSelected(k1, k2, k3, k4)) {
                    ...
                    for (var k2 = 0; k2 < track.effects.length; k2++) {
                        if (app.isTrackFxActive(k1, k2)) {
                            ...
                            label2 = plugin.label();
                            if (!app.isTrackFxSelected(k1, k2)) {
                                var pars = plugin.getParams();
                                if (pars) {
                                    for (var k3 = 0; k3 < pars.length; k3++) {
                                        if (app.isTrackFxParameterSelected(k1, k2, k3)) {
        ...
        for (var k1 = 0; k1 < app.currentSong.effects.length; k1++) {
            if (app.isFxActive(k1)) {
                var plugin = app.currentSong.effects[k1].plugin;
                label1 = plugin.label();
                if (!app.isFxSelected(k1)) {
                    var pars = plugin.getParams();
                    if (pars) {
                        for (var k2 = 0; k2 < pars.length; k2++) {
                            if (app.isFxParameterSelected(k1, k2)) {
        ...
        app.labelsStaticAnchor.content.length = 0;
        app.labelsStaticAnchor.content.push(app.tileLevel.text(0, -app.tileLevel.viewWidth / app.tileLevel.tapSize + 1.0, label1, 'overLabelTrack'));
        app.labelsStaticAnchor.content.push(app.tileLevel.text(0.25, -app.tileLevel.viewWidth / app.tileLevel.tapSize + 1.5, label2, 'overLabelVoice'));
        app.labelsStaticAnchor.content.push(app.tileLevel.text(0.5, -app.tileLevel.viewWidth / app.tileLevel.tapSize + 2.0, label3, 'overLabelVoice'));
        app.labelsStaticAnchor.content.push(app.tileLevel.text(0.75, -app.tileLevel.viewWidth / app.tileLevel.tapSize + 2.5, label4, 'overLabelVoice'));
        /*
        app.labelsStaticAnchor.content.length = 0;
        let trackName = '';
        let voiceName = '';
        if (app.currentSong.selectedLayer.track_songFx < app.currentSong.tracks.length) {
            let track = app.currentSong.tracks[app.currentSong.selectedLayer.track_songFx];
            trackName = track.title;
            if (app.currentSong.selectedLayer.voice_trackFx_songFxParam < track.voices.length) {
                let voice = track.voices[app.currentSong.selectedLayer.voice_trackFx_songFxParam];
                let voiceName = voice.title;

            }
        }
        app.labelsStaticAnchor.content.push(app.tileLevel.text(2
            , -app.tileLevel.viewWidth / app.tileLevel.tapSize + 1.0
            , trackName, 'overLabelTrack'));
        app.labelsStaticAnchor.content.push(app.tileLevel.text(2.5
            , -app.tileLevel.viewWidth / app.tileLevel.tapSize + 1.5
            , voiceName, 'overLabelVoice'));
            */
    }
    ZvoogGrid.resetTrackVoiceName = resetTrackVoiceName;
})(ZvoogGrid || (ZvoogGrid = {}));
var ZvoogTicker;
(function (ZvoogTicker) {
    //at = 0;
    //fr=0;
    function cancelAllSources(app) {
        for (var k1 = 0; k1 < app.currentSong.tracks.length; k1++) {
            var track = app.currentSong.tracks[k1];
            for (var k2 = 0; k2 < track.voices.length; k2++) {
                var voice = track.voices[k2];
    ...
    ZvoogTicker.cancelAllSources = cancelAllSources;
    function cancelAllParameters(app) {
        //console.log('cancelAllParameters');
        for (var k1 = 0; k1 < app.currentSong.tracks.length; k1++) {
            var track = app.currentSong.tracks[k1];
            for (var k2 = 0; k2 < track.voices.length; k2++) {
                var voice = track.voices[k2];
                ...
                if (pars) {
                    for (var k4 = 0; k4 < pars.length; k4++) {
                        ...
                        //console.log('cancelAllParameters source',k1,k2,k4);
                    }
                }
                for (var k3 = 0; k3 < voice.effects.length; k3++) {
                    var effect = voice.effects[k3];
                    ...
                    if (pars) {
                        for (var k4 = 0; k4 < pars.length; k4++) {
                            var zp = pars[k4];
                            zp.cancelScheduledValues(0);
                            //console.log('cancelAllParameters voice fx',k1,k2,k3,k4);
                        }
                    }
                }
            }
            for (var k2 = 0; k2 < track.effects.length; k2++) {
                ...
                if (pars_5) {
                    for (var k3 = 0; k3 < pars_5.length; k3++) {
                        ...
                        //console.log('cancelAllParameters track fx',k1,k2,k3);
                    }
                }
            }
        }
        for (var k1 = 0; k1 < app.currentSong.effects.length; k1++) {
            ...
            if (pars_6) {
                for (var k2 = 0; k2 < pars_6.length; k2++) {
                    var p = pars_6[k2];
                    p.cancelScheduledValues(0);
                    //console.log('cancelAllParameters song fx',k1,k2);
                }
            }
        }
    }
    ZvoogTicker.cancelAllParameters = cancelAllParameters;
    function sendSongData(app, audioTime, fromMs, toMs, startSongSelectionMs, endSongSelectionMs) {
        //console.log('sendSongData', Math.floor(audioTime), 'tick', fromMs, toMs, 'selection', startSongSelectionMs, endSongSelectionMs);
        //console.log('sendSongData', Math.floor(audioTime)-app.at, 'selection',fromMs,toMs);
        //app.at=audioTime;
        //app.fr=fromMs;
        var measureMS = 0;
        for (var i = 0; i < app.currentSong.timeline.length; i++) {
            ...
            if (fromMs < measureMS + measureDurationMs && toMs >= measureMS) {
                for (var k1 = 0; k1 < app.currentSong.tracks.length; k1++) {
                    var track = app.currentSong.tracks[k1];
                    for (var k2 = 0; k2 < track.voices.length; k2++) {
                        var voice = track.voices[k2];
                        if (voice.chunks.length > i) {
                            ...
                            for (var ch = 0; ch < chunk.chords.length; ch++) {
                                var chord = chunk.chords[ch];
                                var chordMs = 1000 * duration2time(measure.tempo, chord.when);
                                if (fromMs <= measureMS + chordMs && toMs > measureMS + chordMs) {
                                    var chordpitches = [];
                                    for (var n = 0; n < chord.values.length; n++) {
                                        var v = chord.values[n];
                                        chordpitches.push(v.envelope);
                                    }
                                    var chordAudioTime = (audioTime + measureMS + chordMs - fromMs) / 1000;
                                    //console.log(k1, k2, i, measure.tempo, measureMS, chordMs, chordpitches);
                                    //app.ttt = Math.round(chordAudioTime * 1000);
    ...
    function sendParametersData(app, audioTime, fromMs, toMs, startSongSelectionMs, endSongSelectionMs) {
        for (var k1 = 0; k1 < app.currentSong.tracks.length; k1++) {
            ...
            for (var k2 = 0; k2 < track.effects.length; k2++) {
                var plugin = track.effects[k2].plugin;
                var pars_7 = plugin.getParams();
                if (pars_7) {
                    for (var k3 = 0; k3 < pars_7.length; k3++) {
                        var p = pars_7[k3];
                    }
                }
            }
        ...
        for (var k1 = 0; k1 < app.currentSong.effects.length; k1++) {
            var effect = app.currentSong.effects[k1];
            var pars_8 = effect.plugin.getParams();
            if (pars_8) {
                for (var k2 = 0; k2 < pars_8.length; k2++) {
                    //console.log(audioTime, fromMs, toMs,k1,k2,effect.parameters.length);
                    if (effect.parameters.length > k2) {
                        var points = effect.parameters[k2].points;
                        var p = pars_8[k2];
                        if (k1 == 0 && k2 == 0) {
                            ZvoogTicker.sendParameterPoints(app, audioTime, fromMs, toMs, p, points, startSongSelectionMs, endSongSelectionMs);
                        }
                    }
                }
            }
    ...
    ZvoogTicker.sendParametersData = sendParametersData;
    function sendParameterPoints(app, audioTime, fromMs, toMs, parameter, points, startSongSelectionMs, endSongSelectionMs) {
        //console.log(audioTime, fromMs, toMs, startSongSelectionMs, endSongSelectionMs);
        var measureS = 0;
        var measureIndex = 0;
        var s384 = 0;
        var ms1 = 0;
        ...
        for (var i = 0; i < points.length && ms1 < toMs; i++) {
            var point = points[i];
            var curMeasure = app.currentSong.timeline[0];
            for (var m = 0; m < point.skipMeasures; m++) {
                measureS = measureS + app.patternDuration(app.currentSong.timeline[measureIndex]);
                curMeasure = app.currentSong.timeline[measureIndex];
                measureIndex++;
                s384 = 0;
            }
            ...
            ms2 = Math.round(seconds * 1000);
            velocity2 = point.velocity;
            if (fromMs == startSongSelectionMs && ms1 <= fromMs && ms2 >= fromMs) {
                //console.log('---reset', ms1, velocity1);
                var velDiff = velocity2 - velocity1;
                var timeDiff = ms2 - ms1;
                if (timeDiff) {
                    var timeSkip = fromMs - ms1;
                    velocity1 = velocity1 + velDiff * (timeSkip / timeDiff);
                }
                ms1 = fromMs;
                parameter.cancelScheduledValues((audioTime + ms1 - fromMs) / 1000);
                parameter.setValueAtTime(velocity1, (audioTime + ms1 - fromMs) / 1000);
            }
            if (ms1 >= fromMs && ms1 < toMs) {
                if (ms1 == ms2) {
                    //console.log('---set', ms1, velocity1, ms2, velocity2);
                    parameter.setValueAtTime(velocity2, (audioTime + ms2 - fromMs) / 1000);
                }
                else {
                    //console.log('---slide', ms1, velocity1, ms2, velocity2);
                    parameter.linearRampToValueAtTime(velocity2, (audioTime + ms2 - fromMs) / 1000);
                }
            }
            ms1 = ms2;
            velocity1 = velocity2;
    ...
    ZvoogTicker.sendParameterPoints = sendParameterPoints;
})(ZvoogTicker || (ZvoogTicker = {}));
