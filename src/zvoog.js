            ...
            groups: [
                {
                    ...
                    content: [
                        {
                            id: 'bgred', css: 'testred', x: 0, y: 0, w: 3000, h: 500, showZoom: 0.1, hideZoom: 1001, rx: 0, ry: 0,
                            action: function (x, y) { console.log('action red'); }
                        },
                        {
                            id: 'cornerblue', css: 'testblue', x: 0, y: 0, w: 100, h: 100, showZoom: 0.1, hideZoom: 1001, rx: 0, ry: 0,
                            action: function (x, y) { console.log('action blue'); }
                        },
                        {
                            id: 'cornerpurple', css: 'testpurple', x: 3000 - 100, y: 0, w: 100, h: 100, showZoom: 0.1, hideZoom: 1001, rx: 0, ry: 0,
                            action: function (x, y) { console.log('action purple'); }
                        },
                        {
                            id: 'cornergreen', css: 'testgreen', x: 3000 - 100, y: 500 - 100, w: 100, h: 100, showZoom: 0.1, hideZoom: 1001, rx: 0, ry: 0,
                            action: function (x, y) { console.log('action green'); }
                        },
                        {
                            id: 'corneryel', css: 'testyellow', x: 0, y: 500 - 100, w: 100, h: 100, showZoom: 0.1, hideZoom: 1001, rx: 0, ry: 0,
                            action: function (x, y) { console.log('action yellow'); }
                        },
                        {
                            id: 'sq1', css: 'onecm1', x: 0, y: 0, w: 1, h: 1, showZoom: 0.1, hideZoom: 1001, rx: 0, ry: 0,
                            action: function (x, y) { console.log('action 1'); }
                        },
                        { id: 'ttline', css: 'testline', x1: 3000 - 20, y1: 20, x2: 20, y2: 500 - 20, showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't01', css: 'testtext01', x: 0, y: 0.1, text: 'Test #01', showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't05', css: 'testtext05', x: 0, y: 0.5, text: 'Test #05', showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't1', css: 'testtext1', x: 0, y: 1, text: 'Test #1', showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't10', css: 'testtext10', x: 0, y: 10, text: 'Test #10', showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't100', css: 'testtext100', x: 0, y: 100, text: 'Test #100', showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't200', css: 'testtext200', x: 0, y: 200, text: 'Test #200', showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't300', css: 'testtext300', x: 0, y: 300, text: 'Test #300', showZoom: 0.1, hideZoom: 1001, action: null },
                        { id: 't500', css: 'testtext500', x: 0, y: 500, text: 'Test #500', showZoom: 0.1, hideZoom: 1001, action: null }
                    ]
                }
            ]
        },
        {
            g: document.getElementById('overlayGroup'),
            overlay: 1,
            groups: [{ id: '22', css: '', x: 0, y: 0, w: 3000, h: 500, action: null, showZoom: 0.1, hideZoom: 1001, content: [
                        { id: 'oversq', css: 'testgreen', x: 0, y: 0, w: 1, h: 1, showZoom: 0.1, hideZoom: 1001, rx: 0, ry: 0, action: null },
                        { id: 'overicn', css: 'testpurple', x: 0, y: 0, scale: 0.3,
                        ...
                        { id: 'over100', css: 'testtext1', x: 0, y: 1, text: 'Overlay', showZoom: 0.1, hideZoom: 1001, action: null }
                    ] }]
        },
        {
            g: document.getElementById('stickLeftGroup'),
            stickLeft: 5,
            groups: [{ id: '33', css: '', x: 0, y: 0, w: 3000, h: 500, action: null, showZoom: 0.1, hideZoom: 1001, content: [
                        { id: 'over1003', css: 'testtext100', x: 0, y: 100, text: 'Left 100', showZoom: 0.1, hideZoom: 1001, action: null }
                    ] }]
        },
        {
            g: document.getElementById('stickRightGroup'),
            stickRight: 5,
            groups: [{ id: '33', css: '', x: 0, y: 0, w: 3000, h: 500, action: null, showZoom: 0.1, hideZoom: 1001, content: [
                        { id: 'over1004', css: 'testtext100', x: -300, y: 200, text: 'right 100', showZoom: 0.1, hideZoom: 1001, action: null }
                    ] }]
        },
        {
            g: document.getElementById('stickTopGroup'),
            stickTop: 5,
            groups: [{ id: '334', css: '', x: 0, y: 0, w: 3000, h: 500, action: null, showZoom: 0.1, hideZoom: 1001, content: [
                        { id: 'over10044', css: 'testtext100', x: 100, y: 0, text: 'top 100', showZoom: 0.1, hideZoom: 1001, action: null }
                    ] }]
        }, {
            g: document.getElementById('stickBottomGroup'),
            stickBottom: 5,
            groups: [{ id: '3345', css: '', x: 0, y: 0, w: 3000, h: 500, action: null, showZoom: 0.1, hideZoom: 1001, content: [
                        { id: 'over100445', css: 'testtext100', x: 500, y: 0, text: 'bottom 100', showZoom: 0.1, hideZoom: 1001, action: null }
                    ] }]
        }
    ];
    var tl = new TileLevel(document.getElementById('contentSVG'), 3000, 500, 0.1, 100, 1000, layers);
    tl.dump();
    //backgroundLayer={};
}
